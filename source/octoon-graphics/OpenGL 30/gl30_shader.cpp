...
namespace octoon
{
	namespace graphics
	{
		...
		void
		GL30GraphicsUniform::setType(GraphicsUniformType type) noexcept
		{
			_type = type;
		}
		...
		void
		GL30GraphicsUniform::setShaderStageFlags(GraphicsShaderStageFlags flags) noexcept
		{
			_stageFlags = flags;
		}
		...
		bool
		GL30Shader::HlslCodes2GLSL(GraphicsShaderStageFlags stage, const std::string& codes, std::string& out)
		{
		...
		bool
		GL30Shader::HlslByteCodes2GLSL(GraphicsShaderStageFlags stage, const char* codes, std::string& out)
		{
#if defined(OCTOON_BUILD_PLATFORM_WINDOWS) && defined(OCTOON_FEATURE_GRAPHICS_USE_HLSL)
		...
		GL30Shader::getGraphicsShaderDesc() const noexcept
		{
			return _shaderDesc;
		}
		...
		GL30Program::getGraphicsProgramDesc() const noexcept
		{
			return _programDesc;
		}
