...
namespace MysticLit
{
	OctoonImplementSubClass(MessageWindow, octoon::GameComponent, "MessageWindow")
	...
	void
	MessageWindow::showPopupMessage(const octoon::runtime::any& data) noexcept
	{
	...
	void
	MessageWindow::showErrorPopupMessage(const octoon::runtime::any& data) noexcept
	{
		if (!_isShowMessageFirst)
		{
