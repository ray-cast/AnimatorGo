	...
	bool prepareLayers(const json& j)
	{
		...
		for (auto& layer : j["layers"])
		{
			...
			case LayerTypes::still:
			{
				...
				object = octoon::GamePrefabs::instance()->createSprite(_textures[refid]);
				object->getComponent<octoon::Transform>()->setLocalScale(octoon::math::float3(100, 100, 100));
			}
			break;
