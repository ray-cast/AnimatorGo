...
namespace octoon
{
	namespace mesh
	{
		...
		public:
			...
			void setWeightArray(const model::VertexWeights& array) noexcept;
			...
			void setWeightArray(model::VertexWeights&& array) noexcept;
			...
			model::VertexWeights& getWeightArray() noexcept;
			...
			const model::VertexWeights& getWeightArray() const noexcept;
			const math::uint1s& getIndicesArray(std::size_t n = 0) const noexcept;

			const model::Bones& getBoneArray(const model::Bones& array) const noexcept;
