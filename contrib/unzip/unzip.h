...
ZEXTERN int ZEXPORT unzGetGlobalComment OF((unzFile file, char *comment, uLong comment_size));
...
ZEXTERN int ZEXPORT unzGetCurrentFileInfo OF((unzFile file, unz_file_info *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
ZEXTERN int ZEXPORT unzGetCurrentFileInfo64 OF((unzFile file, unz_file_info64 *pfile_info, char *filename,
    uLong filename_size, void *extrafield, uLong extrafield_size, char *comment, uLong comment_size));
...
ZEXTERN int ZEXPORT unzLocateFile OF((unzFile file, const char *filename, unzFileNameComparer filename_compare_func));
...
ZEXTERN int ZEXPORT unzGetFilePos OF((unzFile file, unz_file_pos* file_pos));
ZEXTERN int ZEXPORT unzGoToFilePos OF((unzFile file, unz_file_pos* file_pos));
...
ZEXTERN int ZEXPORT unzGetFilePos64 OF((unzFile file, unz64_file_pos* file_pos));
ZEXTERN int ZEXPORT unzGoToFilePos64 OF((unzFile file, const unz64_file_pos* file_pos));

ZEXTERN uLong ZEXPORT unzGetOffset OF((unzFile file));
ZEXTERN ZPOS64_T ZEXPORT unzGetOffset64 OF((unzFile file));
/* Get the current file offset */

ZEXTERN int ZEXPORT unzSetOffset OF((unzFile file, uLong pos));
ZEXTERN int ZEXPORT unzSetOffset64 OF((unzFile file, ZPOS64_T pos));
