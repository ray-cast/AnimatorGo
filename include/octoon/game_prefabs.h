...
namespace octoon
{
	...
	private:
		...
		bool createClothes(const model::Model& model, GameObjectPtr& mesh, const GameObjects& bones, GameObjects& rigidbodys) noexcept;
		...
		bool createMorph(const model::Model& model, GameObjectPtr& mesh) noexcept;
