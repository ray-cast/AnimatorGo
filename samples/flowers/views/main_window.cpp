...
namespace flower
{
		...
		, behaviour_(behaviour)
	{
		...
		this->albedo_.init(u8"???????", CreateFlags::SpoilerBit | CreateFlags::ColorBit | CreateFlags::TextureBit);
		this->opacity_.init(u8"???????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->normal_.init(u8"????", CreateFlags::SpoilerBit | CreateFlags::TextureBit);
		this->roughness_.init(u8"????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->metalness_.init(u8"????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->specular_.init(u8"????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->anisotropy_.init(u8"????????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->sheen_.init(u8"????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->clearcoat_.init(u8"????", CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->clearcoatRoughness_.init(u8"???????", CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->subsurface_.init(u8"?????", CreateFlags::ValueBit | CreateFlags::TextureBit);
		this->subsurfaceValue_.init(u8"??????", CreateFlags::ColorBit | CreateFlags::TextureBit);
		this->refraction_.init(u8"??????", CreateFlags::ValueBit);
		this->refractionIor_.init(u8"??????", CreateFlags::ValueBit);
		this->emissive_.init(u8"?????", CreateFlags::SpoilerBit | CreateFlags::ValueBit | CreateFlags::ColorBit | CreateFlags::TextureBit);
		...
		this->othersSpoiler_ = new Spoiler(u8"????");
	...
	{
		QString path = QFileDialog::getOpenFileName(this, u8"?????", "", tr(imageFormat));
		if (!path.isEmpty())
