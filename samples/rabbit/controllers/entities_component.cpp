...
namespace rabbit
{
	...
	EntitiesComponent::onEnable() noexcept
	{
		...
		envMaterial->setColorTexture(TextureLoader::load(u8"D:/Resources/室内3k/skybox.hdr"));
		...
		enviromentLight->getComponent<octoon::EnvironmentLightComponent>()->setIrradiance(TextureLoader::load(u8"D:/Resources/室内3k/skybox.hdr"));
