...
namespace octoon
{
	namespace graphics
	{
		...
		GL20Types::asTextureInternalFormat(GraphicsFormat format) noexcept
		{
			...
			case GraphicsFormat::R8G8B8UNorm:               internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8SNorm:               internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8UScaled:	            internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8SScaled:	            internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8UInt:                internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8SInt:                internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8SRGB:                internalFormat = GL_RGB; break;
			case GraphicsFormat::R8G8B8A8UNorm:	            internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8SNorm:	            internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8UScaled:	        internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8SScaled:	        internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8UInt:	            internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8SInt:	            internalFormat = GL_RGBA; break;
			case GraphicsFormat::R8G8B8A8SRGB:	            internalFormat = GL_RGBA; break;
			case GraphicsFormat::B8G8R8UNorm:               internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8SNorm:               internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8UScaled:	            internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8SScaled:	            internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8UInt:                internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8SInt:                internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8SRGB:                internalFormat = GL_BGR; break;
			case GraphicsFormat::B8G8R8A8UNorm:	            internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8SNorm:	            internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8UScaled:	        internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8SScaled:	        internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8UInt:	            internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8SInt:	            internalFormat = GL_BGRA; break;
			case GraphicsFormat::B8G8R8A8SRGB:	            internalFormat = GL_BGRA; break;
