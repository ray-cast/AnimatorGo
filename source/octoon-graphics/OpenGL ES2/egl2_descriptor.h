#ifndef OCTOON_EGL2_DESCRIPTOR_H_
#define OCTOON_EGL2_DESCRIPTOR_H_
...
namespace octoon
{
	namespace graphics
	{
		...
		{
			OctoonDeclareSubClass(EGL2GraphicsUniformSet, GraphicsUniformSet)
		public:
		...
		{
			OctoonDeclareSubClass(EGL2DescriptorPool, GraphicsDescriptorPool)
		public:
		...
		{
			OctoonDeclareSubClass(EGL2DescriptorSetLayout, OGLCoreGraphicsData)
		public:
		...
		{
			OctoonDeclareSubClass(EGL2DescriptorSet, OGLCoreGraphicsData)
		public:
