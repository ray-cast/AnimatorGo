...
namespace octoon
{
    namespace audio
    {
        ...
        void AudioSourceAL::set_audio_clip(const AudioClip& clip) noexcept
        {
            ...
            _audio_reader->seekg(_audio_clip.length, ios_base::beg);
        ...
        void AudioSourceAL::_play_start() noexcept
        {
            ...
            for (auto it : _al_buffer)
            {
                ...
                {
                    ::alBufferData(it, _al_format, _data.data(), _audio_reader->gcount(), _audio_clip.freq);
        ...
        void AudioSourceAL::_update_audio_queue() noexcept
        {
            ...
            while (processed--)
            {
                ...
                if (_audio_reader->gcount() > 0)
                {
                    ::alBufferData(buff, _al_format, _data.data(), _audio_reader->gcount(), _audio_clip.freq);
