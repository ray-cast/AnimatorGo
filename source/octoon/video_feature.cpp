...
namespace octoon
{
	...
	{
		this->addMessageListener("input:event", std::bind(&VideoFeature::onInputEvent, this, std::placeholders::_1));
	...
	{
		this->removeMessageListener("input:event", std::bind(&VideoFeature::onInputEvent, this, std::placeholders::_1));
