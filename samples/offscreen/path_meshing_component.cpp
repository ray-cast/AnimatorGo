...
#define POD_TT_PRIM_LINE 1   	// line to, һ�����x,y]
#define POD_TT_PRIM_QSPLINE 2	// qudratic bezier to, �������[controlX,controlY]��[endX,endY]��
#define POD_TT_PRIM_CSPLINE 3	// cubic bezier to, �������[control1X,control1Y]��[control2X,control2Y]��[endX,endY]��
#define POD_TT_PRIM_ARCLINE 4	// arc to, �������[startX,startY]��[endX,endY]��[startDegree,sweepAngle]��
#define POD_TT_PRIM_MOVE 8   	// move to, һ�����x,y]
