...
namespace octoon::mesh
{
	...
	CubeWireframeMesh::CubeWireframeMesh() noexcept
		: CubeWireframeMesh(1, 1, 1)
	{
	}

	CubeWireframeMesh::CubeWireframeMesh(float width, float height, float depth, std::uint32_t widthSegments, std::uint32_t heightSegments, std::uint32_t depthSegments) noexcept
	{
