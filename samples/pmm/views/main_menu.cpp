	...
	MainMenu::onGui() noexcept
	{
		...
		if (imgui::beginMainMenuBar())
		{
			...
			if (imgui::beginMenu(u8"文件"))
			{
				...
				if (imgui::menuItem(u8"输出视频", "CTRL+B")) { this->sendMessage("editor:menu:file:video", true); }
			...
			{
				if (imgui::menuItem(u8"开始播放")) { this->sendMessage("editor:menu:setting:render", true); }
				if (imgui::menuItem(u8"停止播放")) { this->sendMessage("editor:menu:setting:render", false); }
