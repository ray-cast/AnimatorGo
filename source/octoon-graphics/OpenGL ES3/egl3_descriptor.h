#ifndef OCTOON_EGL3_DESCRIPTOR_H_
#define OCTOON_EGL3_DESCRIPTOR_H_
...
namespace octoon 
{
	namespace graphics
	{
		...
		{
			OctoonDeclareSubClass(EGL3GraphicsUniformSet, GraphicsUniformSet)
		public:
		...
		{
			OctoonDeclareSubClass(EGL3DescriptorPool, GraphicsDescriptorPool)
		public:
		...
		{
			OctoonDeclareSubClass(EGL3DescriptorSetLayout, GraphicsDescriptorSetLayout)
		public:
		...
		{
			OctoonDeclareSubClass(EGL3DescriptorSet, GraphicsDescriptorSet)
		public:
